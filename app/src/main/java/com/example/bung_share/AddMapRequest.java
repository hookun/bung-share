...
public class AddMapRequest extends StringRequest {
    ...
    public AddMapRequest(String address, String category, String pay, String closeday, String operationtime,String menuinfo,String userid, Response.Listener<String> listener) {
